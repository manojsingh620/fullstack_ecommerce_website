...
const HorizontalCartProduct = ({ category, heading }) => {
  ...
  return (
    <div className="container mx-auto px-4 my-6 relative">
      ...
      <div
        className="flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-hidden transition-all"
        ref={scrollElement}
      >
        <button
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 grid">
                    ...
                    <button
                      className="text-sm bg-orange-600 hover:bg-orange-700 text-white px-3 py-1 rounded-full mt-1"
